...
const EducationEdit = () => {
    ...
    const handleInputChange = (event, index) => {
        ...
        // let addMoreNewvalue = [...education];

        // const { name, value } = event.target;
        // console.log("regular", name, value);
        // if (value === "Regular") {
    ...
    const handleOnSubmit = (e) => {
        ...
        if (
            ...
            userInfo = delete userInfo["_id"];

            let education = educationData;
            let workExperience = workExperienceData;
            // let t = education.forEach(function(v){ delete v._id });
...
console.log(newArr)
            userInfo.education = newArr;
            userInfo.workExperience = newWorkExpArray;
